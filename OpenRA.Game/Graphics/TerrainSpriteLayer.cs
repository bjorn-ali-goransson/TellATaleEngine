...
namespace OpenRA.Graphics
{
	public sealed class TerrainSpriteLayer : IDisposable
	{
		...
		public void Draw(Viewport viewport)
		{
			...
			var firstRow = 0; // cells.CandidateMapCoords.TopLeft.V.Clamp(0, map.MapSize.Y);
			var lastRow = map.MapSize.Y; // (cells.CandidateMapCoords.BottomRight.V + 1).Clamp(firstRow, map.MapSize.Y);
